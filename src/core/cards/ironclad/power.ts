...
export const ironcladPowerCards = {
    INFLAME: new Card({
        ...
        upgradeData: {
            description: '筋力を3得る',
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('strength', 3); }
        },
    ...
    METALLICIZE: new Card({
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('metallicize', 4); }
        }
    }),
    FIRE_BREATHING: new Card({
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('fire_breathing', 10); }
        }
    }),
    FEEL_NO_PAIN: new Card({
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('feel_no_pain', 4); }
        }
    }),
    COMBUST: new Card({
        id: 'combust',
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('combust', 7); }
        }
    }),
    RUPTURE: new Card({
        id: 'rupture',
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('rupture', 2); }
        }
    }),
    EVOLVE: new Card({
        id: 'evolve',
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('evolve', 2); }
        }
    }),
    DARK_EMBRACE: new Card({
        ...
        upgradeData: {
            cost: 1,
            description: 'カードが廃棄されるたび、1枚カードを引く',
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('dark_embrace', 1); }
        }
    }),
    JUGGERNAUT: new Card({
        id: 'juggernaut',
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('juggernaut', 7); }
        }
    }),
    BARRICADE: new Card({
        id: 'barricade',
        ...
        upgradeData: {
            cost: 2,
            description: 'ターン開始時にブロックが失われなくなる',
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('barricade', 1); }
        }
    }),
    CORRUPTION: new Card({
        id: 'corruption',
        ...
        upgradeData: {
            cost: 2,
            description: 'スキルカードのコストを0にする。スキルを使用するたび、廃棄する。',
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('corruption', 1); }
        }
    }),
    BRUTALITY: new Card({
        id: 'brutality',
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('brutality', 1); }
        }
    }),
    BERSERK: new Card({
        id: 'berserk',
    ...
    DEMON_FORM: new Card({
        ...
        upgradeData: {
            ...
            effect: (s: IEntity, t: IEntity | null) => { s.addStatus('demon_form_plus', 1); } // 強化版用フラグ
        }
    }),
};
